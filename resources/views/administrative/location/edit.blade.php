    ...
    <div class="col-md-8 grid-margin stretch-card offset-md-2">
        <div class="card">
            <div class="card-body">
                ...
                <form class="forms-sample" action="{{route('administrative.location.update',$data->id)}}" method="POST" enctype="multipart/form-data">
                  ...
                  {!! method_field('PUT') !!}
                    ...
                    <div class="form-check form-group   {{ $errors->has('inside_london') ? 'has-danger' : '' }}">
                        <input type="checkbox" class="form-check-input" id="inside_london" name="inside_london" {{isset($data) ? $data->inside_london == 1 ? 'checked':'' : ''}}>
