...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
        <div>
            <h4 class="mb-3 mb-md-0">JobStatus</h4>
        </div>
        ...
        <div class="d-flex align-items-center flex-wrap text-nowrap">
            ...
            @endif
            <div>
                <form action="{{ route('administrative.jobstatus.import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
            ...
            <a href="{{route('administrative.jobstatus.create')}}" class="btn btn-primary btn-icon-text mb-2 mb-md-0">
    ...
    <script>
        $(document).ready(function() {
            $('#datatables').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{{route('administrative.jobstatus.data')}}',
                columns: [
                    {data: 'id', name: 'id'},
        ...
        function deleteData(rowid) {
            let url = '{{ route("administrative.jobstatus.destroy", ":id") }}';
