...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
        <div>
            <h4 class="mb-3 mb-md-0">Professional</h4>
        </div>
        <div class="d-flex align-items-center flex-wrap text-nowrap">
            <a href="{{route('administrative.professional.create')}}" class="btn btn-primary btn-icon-text mb-2 mb-md-0">
    ...
    <script>
        $(document).ready(function() {
            $('#datatables').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{{route('administrative.professional.data')}}',
                columns: [
                    {data: 'id', name: 'id'},
                    ...
                    {data: 'experience_letter', name: 'experience_letter'},
        ...
        function deleteData(rowid) {
            let url = '{{ route("administrative.professional.destroy", ":id") }}';
