...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
        <div>
            <h4 class="mb-3 mb-md-0">Article</h4>
        </div>
        <div class="d-flex align-items-center flex-wrap text-nowrap">
            <a href="{{route('administrative.article.create')}}" class="btn btn-primary btn-icon-text mb-2 mb-md-0">
    ...
    <script>
        $(document).ready(function() {
            $('#datatables').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{{route('administrative.article.data')}}',
                columns: [
                    {data: 'id', name: 'id'},
                    {data: 'type', name: 'type'},
        ...
        function deleteData(rowid) {
            let url = '{{ route("administrative.article.destroy", ":id") }}';
