...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
        <div>
            <h4 class="mb-3 mb-md-0">Subject Create</h4>
        </div>
        <div class="d-flex align-items-center flex-wrap text-nowrap">
            <a href="{{route('administrative.subject')}}" class="btn btn-primary btn-icon-text mb-2 mb-md-0">
...
<div class="row">
    <div class="col-md-8 grid-margin stretch-card offset-md-2">
        <div class="card">
            <div class="card-body">
                <h6 class="card-title">Subject Create</h6>
                <form class="forms-sample" action="{{route('administrative.subject.update',$data->id)}}" method="POST" enctype="multipart/form-data">
