    ...
    <div class="col-md-8 grid-margin stretch-card offset-md-2">
        <div class="card">
            <div class="card-body">
                ...
                <form class="forms-sample" action="{{route('administrative.news.store')}} " method="POST" enctype="multipart/form-data">
                    @csrf
                        <div class="form-group {{ $errors->has('title') ? 'has-danger' : '' }}">
							...
							<label for="exampleFormControlSelect1">Select Is Active</label>
								<select class="form-control js-example-basic-single w-100" id="is_active" name="is_active" required style="width: 100%">
									<option selected disabled>Select  is_active</option>
									<option value='1' {{ '1'== old('is_active')  ? 'selected' : ''}}>Yes/Active</option>
									<option value='0' {{ '0'== old('is_active')  ? 'selected' : ''}}>No/Inactive</option>
								</select>
